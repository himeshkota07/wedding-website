...
insert into events (name, description, event_date, venue_id, dress_code, theme_color, special_instructions, sort_order)
select 'Mehendi', 'Henna ceremony for the bride, family, and friends.', '2026-12-10T16:00:00+05:30', residence.id, 'Green or yellow, festive casual', '#2f7a3a', 'Footwear removed indoors', 1 from residence
union all
select 'Haldi', 'Turmeric ceremony to bless the couple.', '2026-12-11T10:00:00+05:30', residence.id, 'Yellow, clothes you don''t mind staining', '#e6b800', 'Wear old clothes', 2 from residence
union all
select 'Sangeet', 'An evening of music, dance, and performances.', '2026-12-12T19:00:00+05:30', hall.id, 'Indo-western, festive', '#a83279', 'No white or black attire', 3 from hall
union all
select 'Wedding', 'The main wedding ceremony.', '2026-12-13T08:00:00+05:30', hall.id, 'Traditional formal', '#8b3a5c', 'Arrive 30 minutes before the muhurtham', 4 from hall
union all
select 'Reception', 'Evening reception and dinner.', '2026-12-13T19:00:00+05:30', hall.id, 'Formal / evening wear', '#4a3a8b', '', 5 from hall;
...
insert into faqs (question, answer, sort_order) values
  ('What should I wear?', 'Check the dress code on each event on the Events page, it varies by function.', 1),
